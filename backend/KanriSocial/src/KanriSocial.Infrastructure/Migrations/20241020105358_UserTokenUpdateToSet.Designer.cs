...
namespace KanriSocial.Infrastructure.Migrations
{
    ...
    [Migration("20241020105358_UserTokenUpdateToSet")]
    partial class UserTokenUpdateToSet
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("KanriSocial.Domain.Models.Instagram.Post.InstagramPost", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("KanriSocial.Domain.Models.Instagram.User.InstagramUser", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("KanriSocial.Domain.Models.User", b =>
                {
            ...
            modelBuilder.Entity("KanriSocial.Domain.Models.Instagram.Post.InstagramPost", b =>
                {
                    b.HasOne("KanriSocial.Domain.Models.Instagram.User.InstagramUser", "InstagramUser")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("KanriSocial.Domain.Models.User", null)
                        .WithMany()
